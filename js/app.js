(() => {
    ...
    function documentActions(e) {
        ...
        if (window.innerWidth > 768 && isMobile.any()) {
            ...
            if (!targetElement.classList.contains("menu__arrow") && !targetElement.classList.contains("menu__link") && document.querySelectorAll(".menu__item._hover").length > 0) {
                let items = document.querySelectorAll(".menu__item._hover");
